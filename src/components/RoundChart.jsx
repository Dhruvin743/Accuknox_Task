				...
				<div className='w-full h-full py-4 overflow-hidden'>
					<div className='w-full h-full flex'>
						<div className='h-full aspect-square flex flex-col gap-y-0 justify-center items-center relative'>
							...
							></div>
							<div className='z-10 w-min h-min p-0 m-0 text-lg leading-none font-bold'>{total}</div>
							<div className='z-10 w-min h-min p-0 m-0 text-xxs font-medium'>{v1.title[0].toUpperCase()+v1.title.slice(1)}</div>
						</div>
						<div className='w-full h-full flex flex-col justify-start overflow-y-auto scroll-smooth'>
